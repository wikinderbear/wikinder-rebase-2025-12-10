MusicXML is an interchange format for music scores. It is supported by MuseScore and is suitable for practical use. However, it is too verbose to write by hand.
