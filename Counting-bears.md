...
A number is called composite if it can be rearranged into a rectangle; if not, it is called prime.[^4] However, 1 is neither prime nor composite. The first prime numbers are 2, 3, 5, 7, 11, .... 
