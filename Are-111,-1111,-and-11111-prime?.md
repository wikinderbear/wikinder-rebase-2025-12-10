...
$R_2 = 11$ is prime, but neither $R_3$ nor $R_5$ is. Actually, the next primes after $R_2$ are $R_{19}$ and $R_{23}$, followed by $R_{317}$.

## Repdigits

A number like 111, 222, or 4444 is called a <dfn>repdigit</dfn>. Every repunit is a repdigit.

Every repdigit is divisible by a repunit. For example, $777 = 7 \cdot 111$. Therefore, it is not prime, except for repunit primes and single-digit primes 2, 3, 5, and 7.
