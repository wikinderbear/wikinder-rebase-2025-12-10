...
Every repdigit is divisible by a repunit. For example, $777 = 7 \cdot 111$. So it is not prime, except for repunit primes and the single-digit primes 2, 3, 5, and 7.
